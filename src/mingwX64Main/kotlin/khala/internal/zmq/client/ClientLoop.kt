...
internal class QueueState<L, S>(val queue: ArrayDeque<ClientLoopQuery<L, S>>, val pingSocket: ZmqSocket)
...
internal actual class ClientLoop<L, S> actual constructor(
    ...
    private val isolatedQueue: IsolateState<QueueState<L, S>> = createIsolateState(loopId)
